...
% In current experiment directory
fileName_preprocess=strcat(fileName,'_preprocess.mat');
save(fileName_preprocess,'fileName', 'nCells' ,'traces', 'rois', 'pos', 'cells_all', 'cells_ok', 'redcell','redcells_keep', 'F', 'Fneu','si_img','mouse','belt','layer','fov_code','date','d1','d2','-v7.3');
